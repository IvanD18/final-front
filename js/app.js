...
router.register('/registration', RegistrationPage);
router.register('/wall', MainPage);
router.register('/messages', MessagesPage);
router.register('/users/me',ProfilePage);

const [backendUrl, websocketUrl] = ['localhost', '127.0.0.1'].includes(window.location.hostname) ?
  ['http://localhost:9999', 'ws://localhost:9999/ws'] : ['https://newspaper-online.herokuapp.com', 'wss://newspaper-online.herokuapp.com/ws'];
